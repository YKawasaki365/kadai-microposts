<!-- タブ"My profile"->"Followings"->フォロ―の一覧画面 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <ul class="nav nav-justified mb-3">
                ...
                <li class="nav-item"><a class="nav-link disabled" href="{{ route('users.followings', ['id' => $user->id]) }}" class="nav-link {{ Request::is('users/*/followings') ? 'active' : '' }}">Followings <span class="badge badge-secondary">{{ $count_followings }}</span></a></li>
